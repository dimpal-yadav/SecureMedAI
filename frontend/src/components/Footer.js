            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="#" className="transition-colors duration-300">
                  ...
                  {isDark ? socialIcons.facebook.white : socialIcons.facebook.normal}
                </a>
                <a href="#" className="transition-colors duration-300">
                  <span className="sr-only">Twitter</span>
                  {isDark ? socialIcons.twitter.white : socialIcons.twitter.normal}
                </a>
                <a href="#" className="transition-colors duration-300">
                  <span className="sr-only">Instagram</span>
                  {isDark ? socialIcons.instagram.white : socialIcons.instagram.normal}
                </a>
                <a href="#" className="transition-colors duration-300">
