      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Manage hospital operations and user accounts
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-semibold text-gray-900">Doctor Approval</h3>
            </div>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-semibold text-gray-900">Patient Approval</h3>
            </div>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-semibold text-gray-900">Appointment Management</h3>
            </div>
            <p className="text-gray-600 mb-4">
